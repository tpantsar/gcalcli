...
def gcali_patches(monkeypatch):
    ...
    monkeypatch.setattr(GoogleCalendarInterface, 'data_file_path', data_file_path_stub)
...
def patched_google_reauth(monkeypatch):
    ...
    monkeypatch.setattr(google.oauth2.reauth, 'refresh_grant', mocked_refresh_grant)
    return monkeypatch
